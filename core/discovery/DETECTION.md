...
- **Target project root** — the directory containing the orchestra spec folder (`score/` or legacy `ai-orchestra/`). Commonly the same as the repository root.
...
For each detector file in `{{INSTALLED_FOLDER}}/core/discovery/signals/`:
