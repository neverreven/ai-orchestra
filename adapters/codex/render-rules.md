...
- Skills: referenced via trigger phrases below; source files in `ai-orchestra/core/skills/`
...
- **<skill-id>** — <summary line>. Trigger: '<phrase one>', '<phrase two>'. Read: `ai-orchestra/core/skills/<category>/<skill-id>/SKILL.md`.
```
...
| Source path | `ai-orchestra/core/skills/<category>/<skill-id>/SKILL.md` — project-relative path to the source file in the orchestra core. |
