...
| Always-on rules with `globs` (file-scoped activation) | Not supported. | Codex reads `AGENTS.md` for every session unconditionally. | Stack-pack content (PR 6) becomes additional sections in the managed area; cannot be conditionally loaded. |
