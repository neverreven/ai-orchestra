    ...
    "Stop": [
      {
        ...
        "prompt": "First, evaluate the scheduler: read {{INSTALLED_FOLDER}}/core/scheduler/RUNNER.md §0–§3 and run any overdue jobs. If all jobs are up to date, continue immediately. Then, review this conversation for any new project-specific learning...",
        "loop_limit": 1
      }
    ]
  }
